...
public class ProductController {
    ...
    public ProductClosedView findProductByBrandDynamicClosedView(@PathVariable String brand){
        return productService.findByBrandDynamicClosedView(brand);
    }

    @GetMapping("/findProductByBrandDynamicClassBased/{brand}")
    public ProductDTO findProductByBrandDynamicClassBased(@PathVariable String brand){
